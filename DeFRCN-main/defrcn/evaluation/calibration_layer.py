...
class PrototypicalCalibrationBlock:
    ...
    def extract_roi_features(self, img, boxes):
        ...
        #print("conv_featuresize: {}".format(conv_feature.size()))
    ...
    def execute_calibration_2(self, inputs, dts):
