...
PASCAL_VOC_ALL_CATEGORIES = {
    ...
    7: ["aeroplane", "bicycle", "boat",
        "bird", "bus", "cow", "motorbike", "sofa",
    ],
    8: ["secondnew", "boat"
    ],
    9: ["aeroplane", "bicycle", "bird", "bottle", "bus",
        "car", "chair", "cow", "diningtable", "dog",
        "horse", "person", "pottedplant", "train", "tvmonitor",
        "secondnew",
    ],
    10: ["aeroplane", "bicycle", "bottle", "bus",
         "chair", "cow", "diningtable",
        "horse", "pottedplant", "train", "tvmonitor",
        "boat", "cat", "motorbike", "car", "cow", "cat", "person"
        , "bird",
    ],
    11: [
       "secondnew", "person1"
...
PASCAL_VOC_NOVEL_CATEGORIES = {
    ...
    10: [ "boat", "cat", "motorbike", "car", "cow", "cat", "person"
        , "bird",
    ],
    11: [
       "secondnew", "person1"
